...
playerImage = pygame.image.load('Car-dodging-game-master/car1.png')
car3 = pygame.image.load('Car-dodging-game-master/car3.png')
car4 = pygame.image.load('Car-dodging-game-master/car4.png')
playerRect = playerImage.get_rect()
baddieImage = pygame.image.load('Car-dodging-game-master/car2.png')
sample = [car3, car4, baddieImage]
wallLeft = pygame.image.load('Car-dodging-game-master/left.png')
wallRight = pygame.image.load('Car-dodging-game-master/right.png')
